...
export const PublicRoutesArray = [
  ...
  <Route path="katan-silk" element={<KatanSilk />} key="katan" />,
  <Route path="tissue-silk" element={<TissueSilk />} key="tissue" />,
  <Route path="celebrity" element={<CelebritySaree />} key="celebrity" />,
